...
<body>
    <div id="header">
        ...
        <div id="links">
            ...
            <button class="nav">
                <a href="viewPosted.php" id="cp">Posted</a>
            </button>
            <button class="nav">
            ...
            <div id="title">
                ...
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td>
                             <?php echo "<a href='viewPosted.php?id=".$row1['Appointment_ID']."'style='text-decoration:none; font-weight:bold; color:red;'>Cancel</a>";?>
                        </td>
                    </tr>
                    <?php endwhile;?>
                    </tbody>
