...
<body>
    <div id="header">
        ...
        <div id="links">
            <button class="nav">
                <a href="viewAppointments.php" id="cp">New</a>
            </button>
            <button class="nav">
            ...
            <button class="nav">
                <a href="viewCompleted.php">Completed</a>
            </button>
        </div>
    </div>
    <div id="main">
        <div class="schedTable" id="">
            <div id="title">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                    <?php
                        $sql2 = "SELECT * FROM appointment WHERE Status = 'New' AND User_ID = '$ID'";
                    ...
                    <tr>
                        ...
                        <td>
                             <?php echo "<a href='viewAppointments.php?id=".$row1['Appointment_ID']."'style='text-decoration:none; font-weight:bold; color:red;'>Cancel</a>";?>
                        </td>
                    </tr>
                    <?php endwhile;?>
                    </tbody>
