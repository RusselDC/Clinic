...
if($Pos=='Doctor'){
  $query5 = "SELECT * FROM appointment WHERE Doctor_ID = '$Sub_ID' AND Status = 'Cancelled'";
  ...
  $query5 = "SELECT * FROM appointment WHERE Status = 'Cancelled'";
  $result4 = mysqli_query($conn, $query5);
...
<body>
    <div id="container">
        ...
        <div id="bod">
            ...
            <a href="#"style=" font-weight:bold; font-size:20px;color:#333;">CANCELLED</a>
          </div>
