...
if($Pos=='Doctor'){
  $query5 = "SELECT * FROM appointment WHERE Doctor_ID = '$Sub_ID'";
  ...
  $query5 = "SELECT * FROM appointment";
  $result5 = mysqli_query($conn, $query5);
...
<body>
    <div id="container">
        ...
        <div id="bod">
            ...
            <div id="status-btn">
            <a href="#" style="font-weight:bold;font-size:20px;color:#333;">ALL</a>
            <a href="seenew.php"style="text-decoration:none; font-weight:bold;font-size:20px; color:#333;">NEW</a>
            <a href="seepost.php"style="text-decoration:none; font-weight:bold;font-size:20px;color:#333;">POSTED</a>
            ...
            <div style="height:auto;width:100%;text-align:left; margin-left:auto; margin-right:auto; margin-bottom: 10px;">
            <button type="button" class="btn btn-dark" id="excel">Export to Excel</button>
             </div>
                      ...
                      <?php
                            while($row = $result5->fetch_assoc()) {
                              if($row['Status']=='New'){
                                ...
                                echo "<td><a href='Post.php?id=".$row['Appointment_ID']."' style='text-decoration:none; font-weight:bold;'>Post</a></td>";
